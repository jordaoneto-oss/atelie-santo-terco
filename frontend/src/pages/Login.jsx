    ...
    <div className="min-h-screen bg-catholic flex items-center justify-center p-4">
      ...
      <div className="bg-white/95 backdrop-blur-lg rounded-2xl p-8 w-full max-w-md border border-gold-300 shadow-2xl relative">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <input className="w-full p-3 rounded-lg border border-gold-200 bg-offwhite text-brown-800 mb-6 focus:outline-none focus:border-gold-500 placeholder:text-brown-300" type="password" placeholder="Senha" value={password} onChange={e => setPassword(e.target.value)} required />
